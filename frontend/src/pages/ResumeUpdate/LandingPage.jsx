      ...
      <div className="container mx-auto px-4 py-6">
        <header className='flex justify-between items-center mb-16'>
          ...
          {user ? (
            ...
            <button
              className='bg-purple-100 text-sm font-semibold text-black py-2.5 px-7 rounded-lg hover:bg-gray-800 hover:text-white transition-colors cursor-pointer'
        ...
        <div className="text-sm bg-gray-50 text-gray-700 text-center p-5 mt-5">Made by YOURAKHERE</div>
      </div>
